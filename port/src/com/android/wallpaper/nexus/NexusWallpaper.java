...
public class NexusWallpaper extends WallpaperService
{
	...
	private class NexusEngine extends Engine
	{
		...
		public void onCreate(SurfaceHolder holder)
		{
			...
			renderer = new NexusRenderer(getResources(), isPreview());
			view = new WallpaperView();
			view.setEGLContextClientVersion(2);
			view.setEGLConfigChooser(8, 8, 8, 0, 0, 0);
			view.setRenderer(renderer);
			view.setRenderMode(GLSurfaceView.RENDERMODE_WHEN_DIRTY);
			frames = new com.android.wallpaper.common.WallpaperFrames(NexusWallpaper.this, holder, view);
		...
		private class WallpaperView extends GLSurfaceView
		{
			...
			{
				return NexusEngine.this.getSurfaceHolder();
			}
